...
-- Gitsigns
map("n", "<C-p>", "<cmd>Gitsigns preview_hunk<cr>", { desc = "Gitsigns preview hunk"})
-- map("n", "<C-ph>", "<cmd>Gitsigns preview_hunk_inline<cr>", { desc = "Gitsigns preview hunk inline"})
--
...
map("n", "<leader>fd", find_directory_and_focus)
